...
class DashboardMixin(AbstractAction):
    def setCallbacks(self):
        ...
        def update_graphs(selected_date, selected_period, imported_excel):
            return self.updateGraph(selected_date, selected_period, imported_excel)
    ...
    def updateGraph(
        ...
        if "import" in id_component_called:
            ...
            logs.formatAndDisplay(f"{username}: Data update done")
        ...
        # TODO: improve stability by defining default categories
